...
use Troiswa\TestBundle\Entity\Tag;
use Troiswa\TestBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TroiswaTestBundle:Tag')->findAll();

        return $this->render('TroiswaTestBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TroiswaTestBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TroiswaTestBundle:Tag')->find($id);
        ...
        return $this->render('TroiswaTestBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TroiswaTestBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
